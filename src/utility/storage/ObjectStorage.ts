...
import { S3, PutObjectCommandInput, GetObjectCommandInput } from '@aws-sdk/client-s3';
import { Readable } from 'stream';
import { ApiError } from 'utility/error/apiError';
import { ErrorCode } from 'utility/error/ErrorCode';

process.env.AWS_ACCESS_KEY_ID = process.env.AWS_ACCESS_KEY_ID || "SCWQKFBV9QSRDRKHJN7G";
process.env.AWS_SECRET_ACCESS_KEY = process.env.AWS_SECRET_ACCESS_KEY || "69554f92-aeea-4995-8be1-5ba2911f9d76";
